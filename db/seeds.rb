...
#Bars Latino etc.
cabana = Bar.create!(name: "Cabana Café",
...
pasarela = Bar.create!(name: "La Pasarela",
...
calle = Bar.create!(name: "Calle Latino",
...
#Bars Jazz etc.
georges = Bar.create!(name: "Jazz Club Lyon St Georges",
...
clef = Bar.create!(name: "La Clef de Voûte",
...
windy = Bar.create!(name: "Windy Lounge",
...
#Bars Rock etc.
shamrock = Bar.create!(name: "The Sham'rock",
...
berliner = Bar.create!(name: "Bar Berliner",
...
trokson = Bar.create!(name: "Trokson",
...
rockneat = Bar.create!(name: "Rock'n'Eat",
...
latin.each do |genre|
  BarGenre.create!(bar: cabana, genre: genre)
  BarGenre.create!(bar: pasarela, genre: genre)
  BarGenre.create!(bar: calle, genre: genre)
end

jazz.each do |genre|
  BarGenre.create!(bar: georges, genre: genre)
  BarGenre.create!(bar: clef, genre: genre)
  BarGenre.create!(bar: windy, genre: genre)
end

rock.each do |genre|
  BarGenre.create!(bar: shamrock, genre: genre)
  BarGenre.create!(bar: trokson, genre: genre)
  BarGenre.create!(bar: rockneat, genre: genre)
end
